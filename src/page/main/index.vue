	...
	<div style="width: 100%;background: #eee;">
		<el-header>
			<div style="width: 1440px;margin: 0 auto;">
				<div class="title">湖北省自然人综合分析平台</div>
		...
		<el-container style='width: 1440px;margin: 0 auto;'>
		  <el-container>
		    <el-aside width="240px" style='background: #fff;'> 
				<el-menu default-active="1-1" class='el-menu-vertical-demo' active-text-color='#477eff' unique-opened @open='handleOpen' @close="handleClose" style='border: 0;overflow: auto;'>
					<el-submenu index='1'>
						<template slot='title'>
